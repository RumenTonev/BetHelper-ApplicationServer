namespace BetHelper.Web.Controllers
{
    ...
    using BetHelper.Web.Models.Users;
    using BetHelper.Web.Providers;
    using BetHelper.Web.Results;
    ...
    public class UsersController : BaseApiController
    {
        ...
        public UsersController()
            : base(new BetHelperData())
        {
            this.userManager = new ApplicationUserManager(new UserStore<ApplicationUser>(new BetHelperContext()));
        ...
        public IHttpActionResult GetUserInfo()
        {
            ...
            var db = new BetHelperContext();
            var user = db.Users.FirstOrDefault(x => x.UserName == email);
           var isAdmin= this.userManager.IsInRole(user.Id,"admin");
